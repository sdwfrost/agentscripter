(function() {
  ...
  Util = util = u = {
    ...
    scaleOpacity: function(rgba, scale, result) {
      ...
      result[3] = parseFloat(this.clamp(rgba[3] * scale, 0, 1).toFixed(3));
      return result;
    },
    colorStr: function(c) {
      var s;
    ...
    aRamp: function(start, stop, numItems) {
      ...
      for (i = _i = 0; 0 <= numItems ? _i < numItems : _i > numItems; i = 0 <= numItems ? ++_i : --_i) {
        _results.push(start + (stop - start) * (i / (numItems - 1)));
      }
      return _results;
    },
  ...
  Color = {
    ...
    arrayToColor: function(array, type) {
      ...
      switch (type) {
        case "css":
          return Color.triString.apply(Color, array);
        case "pixel":
          return Color.rgbaToPixel.apply(Color, array);
        case "typed":
          if (array.buffer) {
    ...
    colorToArray: function(color) {
      switch (this.colorType(color)) {
        case "css":
          return Color.stringToUint8s(color);
        case "pixel":
          return Color.pixelToUint8s(color);
        case "typed":
          return color;
      }
    ...
    rgbaToColor: function(r, g, b, a, type) {
      ...
      switch (type) {
        case "css":
          return Color.triString(r, g, b, a);
        case "pixel":
          return Color.rgbaToPixel(r, g, b, a);
        case "typed":
  ...
  ColorMaps = {
    gradientImageData: function(nColors, stops, locs) {
      var a, ctx, grad, i, _i, _ref;
      if (u.isArray(stops[0])) {
        stops = (function() {
          var _i, _len, _results;
          _results = [];
          for (_i = 0, _len = stops.length; _i < _len; _i++) {
            a = stops[_i];
            _results.push(Color.arrayToColor(a, "css"));
          }
          return _results;
        })();
      }
    ...
    uint8ArrayToUint8s: function(a) {
      ...
      _results = [];
      for (i = _i = 0, _ref = a.length; _i < _ref; i = _i += 4) {
        _results.push(a.subarray(i, i + 4));
      }
      return _results;
    },
    uint8ArrayToRgbas: function(a) {
      ...
      _results = [];
      for (i = _i = 0, _ref = a.length; _i < _ref; i = _i += 4) {
        _results.push([a[i], a[i + 1], a[i + 2], a[i + 3]]);
      }
      return _results;
    },
    ...
    permuteArrays: function(A1, A2, A3) {
      var a1, a2, a3, array, _i, _j, _k, _len, _len1, _len2;
      if (A2 == null) {
        A2 = A1;
      }
      if (A3 == null) {
    ...
    ColorMapProto: {
      ...
      findClosestIndex: function(r, g, b, a) {
        var b0, bLoc, c, color, d, g0, gLoc, i, ix, ixMin, minDist, r0, rLoc, step, _i, _len, _ref, _ref1;
        if (a == null) {
          a = 255;
        }
        if (this.cube) {
          ...
          _ref = (function() {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              c = _ref[_i];
              _results.push(Math.round(c / step));
            }
            return _results;
          })(), rLoc = _ref[0], gLoc = _ref[1], bLoc = _ref[2];
        ...
        for (i = _i = 0, _len = this.length; _i < _len; i = ++_i) {
          color = this[i];
          _ref1 = Color.colorToArray(color), r0 = _ref1[0], g0 = _ref1[1], b0 = _ref1[2];
    ...
    randomColorMap: function(nColors, type, indexToo) {
      var array, i;
      if (type == null) {
        type = "typed";
      }
    ...
    hslColorMap: function(H, S, L, type, indexToo) {
      ...
      array = (function() {
        ...
        for (_i = 0, _len = hslArray.length; _i < _len; _i++) {
          a = hslArray[_i];
          _results.push(Color.hslString.apply(Color, a));
        }
        return _results;
      })();
      return this.colorMap(this.arrayToColors(array, type), indexToo);
    ...
    alphaColorMap: function(rgb, nOpacities, type, indexToo) {
      var a, array, b, g, r;
      if (nOpacities == null) {
        nOpacities = 256;
      }
      ...
      array = (function() {
        var _i, _len, _ref, _results;
        _ref = u.aIntRamp(0, 255, nOpacities);
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          a = _ref[_i];
          _results.push([r, g, b, a]);
        }
        return _results;
      })();
      return this.colorMap(this.arrayToColors(array, type), indexToo);
  ...
  colorMixin = function(obj, colorName, colorDefault, colorMap, colorType) {
    var colorMapName, colorPropName, colorTitle, getterName, proto, setterName, _ref;
    if (colorMap == null) {
      colorMap = null;
    }
    if (colorType == null) {
    ...
    proto = (_ref = obj.prototype) != null ? _ref : obj;
    ...
    if (!proto[setterName]) {
      proto[setterName] = function(r, g, b, a) {
        ...
        } else if (this[colorMapName]) {
          color = this[colorMapName].findClosestColor(r, g, b, a);
        } else {
  ...
  Model = (function() {
    ...
    Model.prototype.createBreeds = function(breedNames, baseClass, baseSet) {
      var breed, breedClass, breedName, breeds, className, _i, _len, _ref;
      breeds = [];
      breeds.classes = {};
      breeds.sets = {};
      _ref = breedNames.split(" ");
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        breedName = _ref[_i];
